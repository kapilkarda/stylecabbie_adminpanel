            ...
            <table class="table table-bordered table-hover table-responsive DynamicTable">
              ...
              <tbody>
                <?php
                        ...
                        $query="select * from `order`  WHERE status='9'";
                        ...
                        while($row_con = mysqli_fetch_array($sql_con)){
                          ...
                          for ($i=0; $i <count($p_idArray); $i++) { 
                                  ...
                                  $ProductImage=$productResult['photo'];
                                  $printimagepdf=$productResult['printimagepdf'];
                                ...
                                if($product_id==144){  ?>
                                    ...
                                    <tr id='trrow' >
                                        ...
                                        <td class="center" class="numeric"><?php echo $resultp_idCity['brand'].'('.$resultp_idCity['model'].')';?></td>
                                       
                                        <td class="center" class="numeric"><?php echo $ProductQty;?></td>
                                        <td class="center" class="numeric"><?php echo $remark;?></td>
                                    </tr>
                                <?php
                                 }if($product_id==145){  ?>
              ...
              <?php
                        ...
                        $query1="select * from `customorder`  WHERE status='1'";
