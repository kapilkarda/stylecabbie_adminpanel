          ...
          <form  method="GET" action="" enctype="multipart/form-data">
            ...
            <div class="form-group has-success col-md-2">
              <select class="form-control" name="order_type">
                ...
                <option <?php if($_GET['order_type']=='cod'){ echo "selected"; } ?> value="cod">cod</option>
                <option <?php if($_GET['order_type']=='paytm'){ echo "selected"; } ?> value="paytm">paytm</option>
            ...
            <div class="form-group has-success col-md-2">
             <select class="form-control" name="status">
                ...
                <option <?php if($_GET['status']=='23'){ echo "selected"; } ?> value="23">Ready to print</option>
                ...
                if($_GET['btn_search']!=''){
                   ...
                   $where_condition= implode(' and ', $where);
                    ...
                    $old_date=date('Y/m/d h:i:s', strtotime("-7 days"));
                     ...
                     $query="select * from `customorder` WHERE (order_date BETWEEN '$old_date' AND '$cur_date')  ORDER BY customorder_id DESC";
                }
