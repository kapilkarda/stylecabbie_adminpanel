            ...
            <div class="container"> <!-- Start : Inner Page container -->
                <div class="crumbs">    <!-- Start : Breadcrumbs -->
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="current">Category Detail</li>
                    </ul>
                </div>  <!-- End : Breadcrumbs -->
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i>Category Detail</div>                               
                                <div class="actions">
                                    <div class="btn-group">
                                      <a class="btn mini green" href="add_category.php" >
                            ...
                            <div class="portlet-body">
                                <table class="table table-bordered table-hover DynamicTable">
                                    ...
                                    <tbody>
                                      <?php  $sql_con = mysqli_query($con,"SELECT * FROM category ORDER BY `cat_id` ASC");
                                      while($row_con = mysqli_fetch_array($sql_con)) { 
                                      ?>
                               <tr id='trrow".$row_con['id']."' >
                                 <td class="center" class="numeric"><?php echo $row_con['cat_id'];?></td>
                                 <td class="center" class="numeric"><?php echo $row_con['cat_name'];?></td>
                                 <td class="center" class="numeric"><?php echo $row_con['type'];?></td>
                                ...
                                <!--  <td class="center" class="numeric"><?php echo $row_con['url'];?></td> -->
                                  ...
                                  <td class="center" class="numeric">
                                    <a class='btn btn-info' title='student' href="edit_category.php?id=<?php echo $row_con['cat_id'];  ?>"><i class='mdi-content-create'>edit</i></a>
                                    <a class='btn btn-danger' href="categoryDelete.php?id=<?php echo  $row_con['cat_id']?>"  title='Delete'><i class='mdi-content-create'>Delete</i></a>
                                       </td>   
                               </tr>
                               <?php }?>
                                    </tbody>
