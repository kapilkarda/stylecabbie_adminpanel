            ...
            <table id="example" class="table table-bordered table-hover table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="numeric">ADD1</th>
                  <th class="numeric">ADD2</th>
                  <th class="numeric">ADD3</th>
                  <th class="numeric">ADDREMAIL</th>
                  <th class="numeric">ADDRMobile</th>
                  <th class="numeric">SenderMobile</th>
                  <th class="numeric">weight</th>
                  <th class="numeric">COD</th>
                  <th class="numeric">InsVal</th>
                </tr>
              </thead>
              <tbody>
                <?php
                ...
                $first400 = substr($row_con['address'], 0, 59);
                $theRest = substr($row_con['address'], 59);
                ...
                <tr id='trrow' >
                  ...
                  <td class="center" class="numeric"><?php echo $districtname;?></td>
                  <td class="center" class="numeric"><?php echo $row_con['pin_code'];?></td>
                  <td class="center" class="numeric"><?php echo $row_con['name'];?></td>
                  <td class="center" class="numeric"><?php echo $first400;?></td>
                  <td class="center" class="numeric"><?php echo $theRest;?></td>
                  ...
                  <td class="center" class="numeric">8085305205</td> 
                  <td class="center" class="numeric"><?php echo (245*$totalqty);?></td>
