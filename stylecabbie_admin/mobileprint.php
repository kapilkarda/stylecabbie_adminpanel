            ...
            <div class="container"> <!-- Start : Inner Page container -->
                <div class="crumbs">    <!-- Start : Breadcrumbs -->
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="current">Mobile Print Detail</li>
                    </ul>
                </div>  <!-- End : Breadcrumbs -->
                <div class="page-header">   <!-- Start : Page Header -->
                    <div class="page-title">
                        <h3>Mobile Print Detail</h3>
                    </div>
                </div>  <!-- End : Page Header -->
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i>Mobile Print Detail</div>                               
                                <div class="actions">
                                    <div class="btn-group">
                                      <a class="btn mini green" href="add_mobile_print.php" >
                                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Mobile print
                                        </a>    
                                       </div>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <table class="table table-bordered table-hover DynamicTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="numeric">Inner width</th>
                                            <th class="numeric">Inner Height</th>
                                            <th class="numeric">Outer width</th>
                                            <th class="numeric">Outer Height</th>
                                            <th class="numeric">Action</th>
                                            
                                        </tr>
                                    </thead>
                                    <tbody>
                                      <?php  $sql_con = mysqli_query($con,"SELECT * FROM mobileprint ORDER BY id ASC ");
                                      $i=0;
                               ...
                               <tr id='trrow".$row_con['id']."' >
                                 ...
                                 <td class="center" class="numeric"><?php echo $row_con['brand'];?></td>
                                 <td class="center" class="numeric"><?php echo $row_con['model'];?></td>
                                 <td class="center" class="numeric"><?php echo $row_con['innerwidth'];?></td>
                                 <td class="center" class="numeric"><?php echo $row_con['innerheight'];?></td>
                                 <td class="center" class="numeric"><?php echo $row_con['outerwidth'];?></td>
                                 <td class="center" class="numeric"><?php echo $row_con['outerheight'];?></td>
                                  <td class="center" class="numeric">
                                    <a class='btn btn-info' title='student' href="edit_mobile_print.php?id=<?php echo $row_con['id'];  ?>"><i class='mdi-content-create'>Edit</i></a>
