		...
		<div class="container" style="width: 90%; height:523px; border: 1px solid;">
				...
				<div class="col-md-12" >
					<div style="float: left; width:70%;">
						...
						<p><strong><font size=4>Name: </strong><?php echo $row_con['name'];?></font></p>
						    ...
						    <p><strong><font size=4>Pin code: </strong><?php echo $row_con['pin_code'];?></font></p>
			...
			<div class="row col-md-12">
				...
				<div class="col-md-6 " style="float:right;">
						...
						<p>Name:Engineer Master Solutions Pvt. Ltd.</p>
						<p>Address: 210,19A Electronic Complex Pin: 452010</p>
						<p>Mobile No.:8085305205</p>
				</div>
				<div class="col-md-12 " style="font-size: 10px;">
					
						Name:<?php echo $ProductName;?>,info:<?php echo $ProductSize;?>,Qty:<?php echo $ProductQty;?>,Order Id:<?php echo $row_con['order_id'];?>
				</div>
			</div>
		</div>
