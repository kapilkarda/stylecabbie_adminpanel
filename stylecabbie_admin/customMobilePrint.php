      ...
      <div class="col-md-12">
        <div class="portlet box blue">
          ...
          <div class="portlet-body" id="table_wrapper" style="overflow: auto;">
            <form action="printMobileCover.php" method="post" onsubmit="return costommobile();" target="_blank">
              ...
              <table class="table table-bordered table-hover table-responsive DynamicTable">
                <thead>
                  <tr>
                    ...
                    <th class="numeric">Main image</th>
                ...
                <tbody>
                  ...
                  <?php
                      ...
                      $query1="select * from `customorder`  WHERE status='23'";
                            $sql_con1 = mysqli_query($con,$query1);
                            while($row_con1 = mysqli_fetch_array($sql_con1)){

                               if($row_con1['cat_id']==4){
                                    $ProductName='custom mobile cover';
                                    $info=$row_con1['brand'].'('.$row_con1['brand_Model'].')';
                                    $type='M';


                                    $order_id=$row_con1['customorder_id'];
                                    $selectm="SELECT * FROM `mobileprint` WHERE `order_id`='$order_id'";
                                ...
                                <tr id='trrow' >
                                  <td align="center"><input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $row_con1['customorder_id'];?>"/></td>
                                  <td align="center"><img width="50px" src="../<?php echo $row_con1['customPic'];?>"></td>
                                      ...
                                      <td class="center" class="numeric"><?php echo $row_con1['qty'];?></td>
                                      <td class="center" class="numeric"><?php echo $row_con1['text'];?></td>
                                      <td class="center" class="numeric"><?php echo $row_con1['remark'];?></td>
                                      <!-- <td class="center" class="numeric">
                                        <center><button class='btn btn-danger' onclick="changeStatusCus(this.value,<?php echo $row_con1['customorder_id'];?>);" value="20" id="change_s<?php echo $row_con1['customorder_id'];?>">In process</button>
                                                <button class='btn btn-success' style="visibility:hidden;margin-top: -30px;" id="change_sed<?php echo $row_con1['customorder_id'];?>">Processed</button></center>
                                      </td> -->
                                        
                                      <td class="center" class="numeric">
                                        
                                        <a href="query.php?status=1&id=<?php echo $row_con1['customorder_id'];?>&method=reEditImage" target="_blank" class='btn btn-success'>ReEdit</a>
                                      </td>
