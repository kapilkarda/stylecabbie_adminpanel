 ...
 if (isset($_POST['btn_add'])) 
{
  ...
  $msg='';
    ...
    $query =mysqli_query($con,"insert into sleeves(name)values('$name')");
   
   if ($query) 
    {
        header("location:sleeve.php");
    } else {
        $msg="Try Again";
    }
 // }
        ...
        <div class="container">
          ...
          <div class="crumbs">
            <ul id="breadcrumbs" class="breadcrumb">
              <li class="current">
                <i class="fa fa-home"></i>Add Sleeve
              </li>
            </ul>
          </div>
          ...
          <div class="col-md-12">
                ...
                <form  method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group has-success col-md-6">
                        <button class="btn btn-danger" name="btn_add" type="submit">Add Sleeve</button><br/><br/>
                    </div>
                </form>
        </div>
      </div>
