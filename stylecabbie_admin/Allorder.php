            ...
            <div class="form-group has-success col-md-2">
             <select class="form-control" name="status">
                ...
                <option <?php if($_GET['status']=='0'){ echo "selected"; } ?> value="0">Pending</option>
                 <option <?php if($_GET['status']=='9'){ echo "selected"; } ?> value="9">Confirm</option>
                ...
                <option <?php if($_GET['status']=='8'){ echo "selected"; } ?> value="8">Return</option>
                ...
                <option <?php if($_GET['status']=='12'){ echo "selected"; } ?> value="12">Delivered</option>
              ...
              <thead>
                <tr>
                 ...
                 <!--  <th class="numeric">Pin Code</th> -->
                  ...
                  <th class="numeric">Order Type</th>
              ...
              <tbody>
                ...
                /*if($_GET['btn_search']!=''){
                   ...
                   $where_condition= implode(' and ', $where);
                    ...
                    $query="select * from `order` where $where_condition ORDER BY order_id DESC";
              ...
              //  }
                ...
                <tr id='trrow' >
                 ...
                 <!--  <td class="center" class="numeric"><?php echo $row_con['pin_code'];?></td>
                  <td class="center" class="numeric"><?php echo $row_con['state_id'];?></td>
                  <td class="center" class="numeric"><?php echo $row_con['city_id'];?></td> -->
                  ...
                  <td class="center" class="numeric">
                    <a class='btn btn-info' title='edit' target="_blank" href="view_order.php?order_id=<?php echo $row_con['order_id'];  ?>"><i class='mdi-content-create'  >View Details</i></a>
                    <!-- <a class='btn btn-danger' title='edit' target="_blank" href="upload_to_shiprocket.php?order_id=<?php echo $row_con['order_id'];  ?>"><i class='mdi-content-create'  >Upload to Shiprocket</i></a> -->

                    <button class='btn btn-danger' title='edit' target="_blank" 
                   onclick="uploadToShiprocket(<?php echo $row_con['order_id']; ?>);"><i class='mdi-content-create'  >Upload to Shiprocket</i></button>
...
<script type="text/javascript">
  function uploadToShiprocket(order_id){
            var order_id = order_id;
            //alert(order_id);
            $.ajax({
                type:'GET',
                url:"uploadToShiprocket.php",
                data:{ 'order_id':order_id },
                success:function(response){
                  //alert(response);
                  console.log(response); 
                  if (response) {
                    alert("Upload to shiprocket successfully !");
                  }else{
                    alert("Failed !");
                  }
                }
