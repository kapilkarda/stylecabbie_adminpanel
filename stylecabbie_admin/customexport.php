...
<div class="portlet box blue">
  ...
  for($i=0;$i<count($val);$i++){
    ...
    if ($sqll>0) {
      if ($sqll1['status']=='20' || $sqll1['status']=='21') {
        ...
        $query = "UPDATE `customorder` SET `barcode`='". $barcode."',`courier`='". $courier."',`cod_payment_received`='".$cod_payment_received."',`courier_payment`='".$courier_payment."',`status`='21',`update_at`='$date' WHERE `customorder_id`='".$order_id."'";  
