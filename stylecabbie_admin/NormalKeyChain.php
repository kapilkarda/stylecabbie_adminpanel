                                ...
                                <tr id='trrow' >
                                  <td align="center"><input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $data;?>"/></td>
                                      ...
                                      <td class="center" class="numeric">
                                        <a href="editImage.php?order=<?php echo $row_con1['customorder_id']?>"" target="_blank" class='btn btn-info'> <i class="fa fa-edit"></i> ReEdit</a>
                                        <!-- <a href="custom_printmobile.php?order=<?php echo $row_con1['customorder_id']?>&size="<?php echo $info;?>" target="_blank" class='btn btn-info'> <i class="fa fa-print"></i> Print</a> --></td>
                                      </tr>
                              <?php
