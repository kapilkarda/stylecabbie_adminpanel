 ...
 if(!isset($_SESSION)) 
   ...
   if (isset($_POST['btn_update'])) 
  {
    ...
    $name = $_POST['name'];
        ...
        echo $sql ="UPDATE `colour` SET   `name`='$name' where id='$id'";
...
select 
{
    ...
    <body>
        ...
        <div class="container">
          ...
          <div class="crumbs">
            <ul id="breadcrumbs" class="breadcrumb">
              <li class="current">
                <i class="fa fa-home"></i>Edit Colour 
              </li>
            </ul>
          </div>
      ...
      {   
               $id= $_GET['id'];  
              $sql1="select * from colour where id='$id'";
                    ...
                    <div class="col-md-12">
                      ...
                      <span id="msg" style="color: red;"></span>
                       ...
                       <div class="form-group has-success col-md-8">
                          <label class="control-label" for="inputSuccess1">Colour Name<span style="color:red;">*</span></label>
