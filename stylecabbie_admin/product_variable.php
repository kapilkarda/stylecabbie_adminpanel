                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body">
                                <table class="table table-bordered table-hover DynamicTable">
                                    ...
                                    <tbody>
                                      <?php  $sql_con = mysqli_query($con,"SELECT * FROM `product_variant` WHERE product_id='".$_GET['id']."' order by `id` desc ");
                               ...
                               <tr id='trrow".$row_con['id']."' >
                                <td class="center" class="numeric"><?php echo $row_con['id'];?></td>
                                 ...
                                 <td class="center" class="numeric"><?php echo $row_con['name'];?></td>
                                  <!-- <td class="center" class="numeric"><img src="<?php echo "img/".$row_con['photo'];?>" style="height: 100px;width: 100px;"></td> -->
                                  <td class="center" class="numeric"><?php echo $row_con['color'];?></td>
                                 <td class="center" class="numeric"><?php echo $row_con['size'];?></td>
                                 <td class="center" class="numeric"><?php echo $row_con['sleeve'];?></td>
                                 ...
                                 <td class="center" class="numeric">
                                    <?php 
                                          if($row_con['thumbnail']!=''){ 
                                            $get_record_img         = mysqli_query($con, "SELECT * FROM `product_image` WHERE id = '".$row_con['thumbnail']."'");
                                              $fetch_record_img = mysqli_fetch_array($get_record_img);
                                    ?>
                                            <img src="<?php echo "".$fetch_record_img['image'];?>" style="height: 50px;width: 50px;"></td>
                                    <?php   
                                          }else{
                                    ?>
                                            <a class='btn btn-success' title='student' href="add_thumbnail_variable_product.php?product_id=<?php echo $_GET['id'];  ?>&id=<?php echo $row_con['id'];  ?>"><i class='mdi-content-create'>Add Thumbnail</i></a>
                                    <?php
                                           }
                                    ?></td>
                                  <td class="center" class="numeric">
                                    <a class='btn btn-info' title='student' href="edit_product_variable.php?id=<?php echo $row_con['id'];  ?>"><i class='mdi-content-create'>edit</i></a>
                                    <a class='btn btn-success' title='student' href="add_images_variable_product.php?product_id=<?php echo $_GET['id'];  ?>&id=<?php echo $row_con['id'];  ?>"><i class='mdi-content-create'>Add Images</i></a>
                                    <a class='btn btn-danger'  onclick="delete_user('<?php echo $row_con['id']; ?>')" title='Delete'><i class='mdi-content-create'>Delete</i></a>
                                       </td>   
                               </tr>
                               <?php }?>
                                    </tbody>
