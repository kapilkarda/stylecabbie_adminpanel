...
error_reporting(E_ALL); ini_set('display_errors', 1);
 ...
 if (isset($_POST['btn_add'])){
  //$id = $_POST['id'];
        ...
        $query_image =mysqli_query($con,"UPDATE `product_variant` SET `images`='$images' WHERE id='$varient_product_id'");
              ...
              <form  method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group has-success col-md-12">
                  ...
                  <div class="form-group has-success col-md-3">
                    ...
                    <input type="checkbox" class="form-control" id="inputSuccess1" name="images[]" value="<?php echo $row1['id']; ?>" style="display: inline-block;width: 46% !important;">
                  </div>
                  <?php } ?>
                </div>
