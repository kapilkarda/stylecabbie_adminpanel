...
<?php 
  ...
  include('sidebar.php'); 
          ...
          if (isset($_POST['reEdit'])) {
             ...
             $mobileResult=mysqli_query($con,"UPDATE customorder SET status='1' WHERE customorder_id='".$order_id."'");
            }
              ...
              <table class="table table-bordered table-hover table-responsive DynamicTable">
                ...
                <tbody>
                  ...
                  <?php
                      ...
                      $query1="select * from `vendormobileprint`  WHERE status='1' order by id DESC";
                            ...
                            while($row_con1 = mysqli_fetch_array($sql_con1)){
                                ...
                                ?>
                                <tr id='trrow' >
                                  <td align="center"><input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $row_con1['order_id'];?>" /></td>
                                    <td class="center" class="numeric"><?php echo $i; ?></td>
                                      <td>
                                        <img width="100px" src="<?php echo $row_con1['image'];?>">
                                      <td class="center" class="numeric"><?php echo $row_con1['order_id'];?></td>
                                      <td class="center" class="numeric"><?php echo $row_con1['brand'];?></td>
                                      <td class="center" class="numeric"><?php echo $row_con1['model'];?></td>
                                      <td class="center" class="numeric"><?php echo $row_con1['innerheight'];?></td>
                                      <td class="center" class="numeric"><?php echo $row_con1['innerwidth'];?></td>
                                     
                                        
                                      <td class="center" class="numeric">
                                        
                                        <a href="query.php?status=1&id=<?php echo $row_con1['order_id'];?>&method=reEditImage" class='btn btn-success'>ReEdit</a>
                                      </td>
