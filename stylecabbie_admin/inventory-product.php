            ...
            <div class="container"> <!-- Start : Inner Page container -->
                <div class="crumbs">    <!-- Start : Breadcrumbs -->
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="current">Inventory Detail</li>
                    </ul>
                </div>  <!-- End : Breadcrumbs -->
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i>Inventory Detail</div>                               
                                <div class="actions">
                                    <div class="btn-group">
                                      <a class="btn mini green" href="add_inventory_pro.php" >
                                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Inventory Product
                                        </a>    
                                       </div>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <table class="table table-bordered table-hover DynamicTable">
                                    <thead>
                                        <tr>
                                           ...
                                           <th class="numeric">Sleeves</th>
                                            <th class="numeric">Size</th>
                                            <th class="numeric">Quantity</th>
                                            <th class="numeric">Colors</th>
                                    ...
                                    <tbody>
                                      <?php  $sql_con = mysqli_query($con,"SELECT * FROM `inventory_product` order by `product_id` desc ");
                               ...
                               <tr id='trrow".$row_con['id']."' >
                                ...
                                <!--  <td class="center" class="numeric"><?php echo $cat_name;?></td>
                                 ...
                                 <td class="center" class="numeric"><?php echo $row_con['product_qty'];
                                 ?></td>
                                ...
                                <!--  <td class="center" class="numeric"><?php echo $row_con['description'];?></td> -->
                                  ...
                                  <td class="center" class="numeric">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <a class='btn btn-info' title='student' href="edit_inventory_pro.php?id=<?php echo $row_con['product_id'];  ?>"><i class='mdi-content-create'>edit</i></a>
