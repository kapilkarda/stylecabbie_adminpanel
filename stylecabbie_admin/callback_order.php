   ...
   if (isset($_POST['btn_submit'])) 
  {
    ...
    foreach ($mobile as $value) {
        ...
        if(mysqli_num_rows($queryCheck)==0){
          ...
          $sqlCart ="INSERT into `callback_order` (`mobile`,`created_at`) VALUES ('$value','$date')";
    ...
    if($queryCart){
        ...
        header("location:callback_order.php");
      }
            ...
            <table class="table table-bordered table-hover table-responsive DynamicTable">
              ...
              <tbody>
                <?php
                  ...
                  $query="select * from `callback_order` WHERE `status`='0' ORDER BY id DESC";
