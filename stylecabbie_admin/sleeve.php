            ...
            <div class="container"> <!-- Start : Inner Page container -->
                <div class="crumbs">    <!-- Start : Breadcrumbs -->
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="current">Sleeve Detail</li>
                    </ul>
                </div>  <!-- End : Breadcrumbs -->
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i>Sleeve Detail</div>                               
                                <div class="actions">
                                    <div class="btn-group">
                                      <a class="btn mini green" href="add_sleeve.php" >
                                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Sleeve
                                        </a>    
                                       </div>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <table class="table table-bordered table-hover DynamicTable">
                                    ...
                                    <tbody>
                                      <?php  $sql_con = mysqli_query($con,"SELECT * FROM sleeves ORDER BY id ASC ");
                                      $i=0;
                               ...
                               <tr id='trrow".$row_con['id']."' >
                                 ...
                                 <td class="center" class="numeric"><?php echo $row_con['name'];?></td>
                                  <td class="center" class="numeric">
                                    <a class='btn btn-info' title='student' href="edit_sleeve.php?id=<?php echo $row_con['id'];  ?>"><i class='mdi-content-create'>Edit</i></a>
