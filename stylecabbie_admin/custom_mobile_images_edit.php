...
<?php 
  ...
  include('sidebar.php');
      ...
      if (isset($_POST['upload'])) {
             $customorder_id=$_POST['customorder_id'];
             $brand=$_POST['brand'];
             ...
             $date=date('Ymdhis');
                  ...
                  $path1 = "editCropImages/".$date.$_FILES["picture"]["name"];
                  if(move_uploaded_file($_FILES["picture"]["tmp_name"], $path1)){
                   ...
                   $query="INSERT INTO `mobileprint` (`order_id`,`image`,`brand`,`model`,`innerwidth`,`innerheight`,`date`) VALUES ('$customorder_id','$path1','$brand','$brand_Model','$innerwidth','$innerheight','$main_date')";
              ...
              <table class="table table-bordered table-hover table-responsive DynamicTable">
                ...
                <tbody>
                  <?php
                      ...
                      $query1="select * from `customorder`  WHERE `status`='23' and `cat_id`='4' ";
                            ...
                            while($row_con1 = mysqli_fetch_array($sql_con1)){
                               ...
                               if($row_con1['cat_id']==4 ){
                                    ...
                                    $brand_Model=$row_con1['brand_Model'];
                                    $brand_Model = ltrim($brand_Model);
                                ...
                                <tr id='trrow' >
                                    ...
                                    <td><img width="100px" src="../<?php echo $row_con1['customPic'];?>">
                                    <td class="center" class="numeric"><?php echo $row_con1['customorder_id'];?></td>
                                    <td class="center" class="numeric"><?php echo $row_con1['brand'];?></td>
                                    <td class="center" class="numeric"><?php echo $row_con1['brand_Model'];?></td>
                                    ...
                                    <td class="center" class="numeric">
                                      <form action="" method="POST" enctype="multipart/form-data">
                                        <input required type="file" name="picture" class="form-control" style="width: 36%;">
                                          <input type="hidden" name="customorder_id" class="form-control" value="<?php echo $row_con1['customorder_id'];?>">
                                          <input type="hidden" name="brand" class="form-control" value="<?php echo $row_con1['brand'];?>">
                                          <input type="hidden"  name="brand_Model" class="form-control" value="<?php echo $row_con1['brand_Model'];?>">
