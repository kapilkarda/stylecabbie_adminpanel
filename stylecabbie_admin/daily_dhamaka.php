            ...
            <div class="container"> <!-- Start : Inner Page container -->
                <div class="crumbs">    <!-- Start : Breadcrumbs -->
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="current">Dhamaka Product Detail</li>
                    </ul>
                </div>  <!-- End : Breadcrumbs -->
                <div class="page-header">   <!-- Start : Page Header -->
                    <div class="page-title">
                        <h3>Dhamaka Product Detail</h3>
                    </div>
                </div>  <!-- End : Page Header -->
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i>Dhamaka Product Detail</div>                               
                               <!--  <div class="actions">
                                    <div class="btn-group">
                            ...
                            <div class="portlet-body">
                                <table class="table table-bordered table-hover DynamicTable">
                                    ...
                                    <tbody>
                                      <?php  $sql_con = mysqli_query($con,"SELECT * FROM daily_dhamaka");
                                      $i=0;
                               ...
                               <tr id='trrow".$row_con['id']."' >
                                 ...
                                 <td class="center" class="numeric"><?php echo $row_con['name'];?></td>
                                  <td class="center" class="numeric"><center>
                                    <?php if (!empty($row_con['photo'])) { ?>
                                    <img src="<?php echo $row_con['photo'];?>" height="100px" width="100px">
                                    <?php }else{ echo ''; } ?>
                                 ...
                                 <td class="center" class="numeric"><?php echo $row_con['description'];?></td>
                                  <td class="center" class="numeric">
                                    <a class='btn btn-info' title='student' href="edit_daily_dhamaka.php?id=<?php echo $row_con['id'];  ?>"><i class='mdi-content-create'>Edit</i></a>
